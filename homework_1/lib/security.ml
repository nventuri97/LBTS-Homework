...
(*List that contains the identificators of secret variable or function*)
type secret = ide list

(*List that contains the indentificators of the function defined 
...
(*
Get the handled functions from a trusted environment.
*)
